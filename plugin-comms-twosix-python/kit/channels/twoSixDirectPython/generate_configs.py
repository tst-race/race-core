...
def main() -> None:
    """
    Purpose:
        Generate configs for twoSixDirectPython
    Args:
        N/A
    Returns:
        N/A
...
if __name__ == "__main__":
    ...
    logging.basicConfig(
        stream=sys.stdout,
        level=LOG_LEVEL,
        format="[generate_comms_python_direct_configs] %(asctime)s.%(msecs)03d %(levelname)s %(message)s",
