...
# RACE app
APP_PREFIX=${PREFIX}/lib/race/core/race
install --backup=numbered -D --mode=755 --target-directory=${DESTDIR}${APP_PREFIX}/bin/ ${DIR}/race/bin/*
install --backup=numbered -D --mode=644 --target-directory=${DESTDIR}${APP_PREFIX}/lib/ ${DIR}/race/lib/*.so
install --backup=numbered -D --mode=644 --target-directory=${DESTDIR}${APP_PREFIX}/lib/java ${DIR}/race/lib/java/*.jar
install --backup=numbered -D --mode=644 --target-directory=${DESTDIR}${APP_PREFIX}/lib/python ${DIR}/race/lib/python/*.py
install --backup=numbered -D --mode=644 --target-directory=${DESTDIR}${APP_PREFIX}/lib/python ${DIR}/race/lib/python/*.so
