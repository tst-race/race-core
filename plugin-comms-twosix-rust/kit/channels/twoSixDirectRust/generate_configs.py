...
def main() -> None:
    """
    Purpose:
        Generate configs for twoSixDirectRust
    Args:
        N/A
    Returns:
        N/A
...
if __name__ == "__main__":
    ...
    logging.basicConfig(
        stream=sys.stdout,
        level=LOG_LEVEL,
        format="[generate_comms_rust_direct_configs] %(asctime)s.%(msecs)03d %(levelname)s %(message)s",
