...
def main() -> None:
    """
    Purpose:
        Generate configs for Network Manager Two Six Labs Python Plugin
    Args:
        N/A
    Returns:
        N/A
...
if __name__ == "__main__":
    ...
    logging.basicConfig(
        stream=sys.stdout,
        level=LOG_LEVEL,
        format="[generate_network_manager_python_configs] %(asctime)s.%(msecs)03d %(levelname)s %(message)s",
