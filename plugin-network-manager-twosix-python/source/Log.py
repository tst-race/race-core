...
def logDebug(message):
    ...
    """
    RaceLog.logDebug("PluginNetworkManagerTwoSixPython", message, "")
...
def logInfo(message):
    ...
    """
    RaceLog.logInfo("PluginNetworkManagerTwoSixPython", message, "")
...
def logWarning(message):
    ...
    """
    RaceLog.logWarning("PluginNetworkManagerTwoSixPython", message, "")
...
def logError(message):
    ...
    """
    RaceLog.logError("PluginNetworkManagerTwoSixPython", message, "")
