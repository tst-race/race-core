...
docker-compose -p twosix-file-server -f "${BASE_DIR}/docker-compose-fileserver.yml" stop
docker-compose -p twosix-file-server -f "${BASE_DIR}/docker-compose-fileserver.yml" down
